export const PROVIDER_IDS = ["openai", "anthropic", "gemini", "deepseek", "meta"] as const;
 ...
 */
export const INDUSTRY_AGENT_IDS = ["legal", "healthcare", "finance", "technology", "general"] as const;
